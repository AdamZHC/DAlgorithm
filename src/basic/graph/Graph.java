...
//        basic.graph.addEdges("北京","上海",200);
//        basic.graph.addEdges("北京","广州",400);
//        basic.graph.addEdges("北京","深圳",250);
//        basic.graph.addEdges("上海","广州",100);
//        basic.graph.addEdges("上海","深圳",180);
//        basic.graph.addEdges("深圳","广州",200);
//        basic.graph.show();
    }
    //使用邻接矩阵表示图
